...
import in.tagbin.mitohealthapp.Fragments.FoodFragment;
import in.tagbin.mitohealthapp.Fragments.SleepFragment;
import in.tagbin.mitohealthapp.Fragments.WaterFragment;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (calendar.getTimeInMillis() > dates[0].getTimeInMillis() || calendar.getTimeInMillis() < dates[3].getTimeInMillis()){
                    Toast.makeText(DailyDetailsActivity.this,"Can't log data for this date",Toast.LENGTH_LONG).show();
                }else {
