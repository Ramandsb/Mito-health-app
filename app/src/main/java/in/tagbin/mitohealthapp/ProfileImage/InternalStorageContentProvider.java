package in.tagbin.mitohealthapp.ProfileImage;
...
import in.tagbin.mitohealthapp.ProfilePage;
...
public class InternalStorageContentProvider extends ContentProvider {
	...
	public ParcelFileDescriptor openFile(Uri uri, String mode) throws FileNotFoundException {
		File f = new File(getContext().getFilesDir(), ProfilePage.TEMP_PHOTO_FILE_NAME);
		if (f.exists()) {
