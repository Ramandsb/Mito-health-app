...
public class UpcomingEventsAdapter extends RecyclerView.Adapter<UpcomingEventsAdapter.MyViewHolder> {
    ...
    public UpcomingEventsAdapter(Context context, List<DataObject> mylist, GifImageView progressBar) {
        mycontext = context;
        newlist = mylist;
    ...
    @Override
    public UpcomingEventsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(this.mycontext).inflate(R.layout.item_lookup, parent, false);
        UpcomingEventsAdapter.MyViewHolder viewHolder = new UpcomingEventsAdapter.MyViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final UpcomingEventsAdapter.MyViewHolder holder, final int position) {
        ((UpcomingEventsAdapter.MyViewHolder) holder).populateData(newlist.get(position), mycontext,mProgressBar);
    }
