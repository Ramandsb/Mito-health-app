...
final class StickyHeaderPositioner {
    ...
    /**
     * Adds margins to item_chat_activity/right (or top/bottom in horizontal orientation)
     * <p>
     * Top padding (or item_chat_activity padding in horizontal orientation) with clipToPadding = true is not
     * supported. If you need to offset the top (or item_chat_activity in horizontal orientation) and do not
